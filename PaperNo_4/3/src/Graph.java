...
//print line 1: vertex, line2 : last 3 vertices
        line1 += v[i];
        while (!s.isEmpty()) {
            i = s.pop();
//            System.out.print("->" + i);
        ...
        for (i = lastSelected.size() - 3; i < lastSelected.size(); i++) {
            if (i == lastSelected.size() - 3) {
                line2 += v[lastSelected.get(i)];
            } else {
                line2 += " " + v[lastSelected.get(i)];
            }
        }
